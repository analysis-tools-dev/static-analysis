...
- [rufo](https://github.com/ruby-formatter/rufo) :warning: — An opinionated ruby formatter, intended to be used via the command line as a text-editor plugin, to autoformat files on save or on demand.
...
- [cargo-breaking](https://github.com/iomentum/cargo-breaking) :warning: — cargo-breaking compares a crate's public API between two different branches, shows what changed, and suggests the next version according to semver.
...
- [dbcritic](https://github.com/channable/dbcritic) :warning: — dbcritic finds problems in a database schema, such as a missing primary key constraint in a table.
