...
- [Svace](https://www.ispras.ru/en/technologies/svace/) :copyright: - A commercial static analysis platform for scanning of multiple languages(C, C++, C#, Java, Kotlin, and Go).
