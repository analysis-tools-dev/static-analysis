...
* [Security Code Scan](https://security-code-scan.github.io/) - Security code analyzer for C# and VB.NET. Detects various security vulnerability patterns: SQLi, XSS, CSRF, XXE, Open Redirect, etc.
* [Semmle QL and LGTM](https://semmle.com/) :copyright: - Deep semantic code analysis using a powerful query language, integrated in developer workflow using automatic code review for pull requests. Free for open source projects on [LGTM.com](https://LGTM.com). Supports C/C++, C#, Cobol, Java, JavaScript, Python, TypeScript.
