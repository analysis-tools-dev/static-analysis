...
* [Puma Scan](https://github.com/pumasecurity/puma-scan) - Puma Scan provides real time, continuous secure code analysis as development teams write code in Visual Studio. Vulnerability categories include XSS, SQLi, CSRF, path tampering, LDAP injection, insecure cryptography, session hijacking, insecure deserialization, weak validation, unvalidated redirects, poor password management, and more.
