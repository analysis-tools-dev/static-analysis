...
* [Teamscale](https://www.teamscale.com) :copyright: - A commercial incremental software quality platform with a focus on fast analysis feedback and usability. Supports multiple languages (ABAP, Ada, C#, C/C++, Cobol, Delphi, Fortran, Groovy, Gosu, IEC 61131-3 ST, Java, JavaScript, Kotlin, Matlab, Open CL, OScript, PHP, PL/SQL, Python, Rust, Simulink/StateFlow, SQLScript, Swift, TypeScript, Visual Basic .NET, and Xtend)
