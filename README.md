...
* [Embold](https://embold.io) :copyright: - An intelligent software analytics platform that identifies issues from multiple lenses: Design issues, code issues, duplication and metrics. Available for Java, C, C++, C#, Objective C, JavaScript, TypeScript, Python, PHP, Go, Kotlin, Solidity and SQL.
