...
* [Spoon](https://github.com/INRIA/spoon) - Library to write your own static analyses and architeral rule checkers for Java. Can be integrated in Maven and Gradle.
