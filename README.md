...
* [Security Code Scan](https://security-code-scan.github.io/) - Security code analyzer for C# and VB.NET. Detects various security vulnerability patterns: SQLi, XSS, CSRF, XXE, Open Redirect, etc.
* [Semmle QL and LGTM](https://semmle.com/) :copyright: - Find security new vulnerabilities, variants, and critical code quality problems using queries over source code. Automatic code review for pull requests; free for public GitHub/Bitbucket repos: [LGTM.com](https://LGTM.com).
...
* [LGTM.com](https://lgtm.com/) :copyright: - Deep code analysis for GitHub and Bitbucket to find security vulnerabilities and critical code quality problems (using [Semmle QL](https://semmle.com)). Automatic code review for pull requests; free for public repositories.
